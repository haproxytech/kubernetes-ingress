...
| [clean-certs](#clean-certs) :construction:(dev) | [bool](#bool) | "true" |  |:large_blue_circle:|:white_circle:|:white_circle:|
| [client-ca](#authentication) :construction:(dev) | string |  | ssl-offloading |:large_blue_circle:|:white_circle:|:white_circle:|
...
| [frontend-config-snippet](#config-snippet) :construction:(dev) | string |  |  |:large_blue_circle:|:white_circle:|:white_circle:|
| [stats-config-snippet](#config-snippet) :construction:(dev) | string |  |  |:large_blue_circle:|:white_circle:|:white_circle:|
...
| [route-acl](#route-acl) :construction:(dev) | string |  |  |:white_circle:|:white_circle:|:large_blue_circle:|
| [send-proxy-protocol](#send-proxy-protocol) | ["proxy", "proxy-v1", "proxy-v2", ""] |  |  |:large_blue_circle:|:large_blue_circle:|:large_blue_circle:|
