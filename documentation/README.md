...
| [client-ca](#client-ca) :construction:(dev) | string |  |  |:large_blue_circle:|:white_circle:|:white_circle:|
...
##### `client-ca`
  ...
  Sets the certificate authority for client certificate checking on HTTPS frontend.

  Available on:  `configmap`

  :information_source: You must set TLS ingress counterpart to activate the client certificate authority configuration.
