...
| [auth-realm](#authentication) :construction:(dev) | string | "Protected Content" | auth-type, auth-secret |:large_blue_circle:|:large_blue_circle:|:white_circle:|
...
| [cors-enable](#CORS) :construction:(dev) | [bool](#bool) | "false" |  |:large_blue_circle:|:large_blue_circle:|:white_circle:|
| [cors-allow-origin](#CORS) :construction:(dev) | string | "*" | cors-enable |:large_blue_circle:|:large_blue_circle:|:white_circle:|
| [cors-allow-methods](#CORS) :construction:(dev) | string | "*" | cors-enable |:large_blue_circle:|:large_blue_circle:|:white_circle:|
| [cors-allow-credentials](#CORS) :construction:(dev) | [bool](#bool) | "false" | cors-enable |:large_blue_circle:|:large_blue_circle:|:white_circle:|
| [cors-allow-headers](#CORS) :construction:(dev) | string | "*" | cors-enable |:large_blue_circle:|:large_blue_circle:|:white_circle:|
| [cors-max-age](#CORS) :construction:(dev) | [time](#time) | "5s" | cors-enable |:large_blue_circle:|:large_blue_circle:|:white_circle:|
...
| [request-redirect](#request-redirect) :construction:(dev) | string |  |  |:large_blue_circle:|:large_blue_circle:|:white_circle:|
| [request-redirect-code](#request-redirect) :construction:(dev) | number | 302 | request-redirect |:large_blue_circle:|:large_blue_circle:|:white_circle:|
...
| [ssl-redirect-port](#https) :construction:(dev) | number | 443 | tls-secret |:large_blue_circle:|:large_blue_circle:|:white_circle:|
