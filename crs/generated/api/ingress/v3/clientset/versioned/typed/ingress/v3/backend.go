...
type BackendInterface interface {
	Create(ctx context.Context, backend *v3.Backend, opts v1.CreateOptions) (*v3.Backend, error)
	Update(ctx context.Context, backend *v3.Backend, opts v1.UpdateOptions) (*v3.Backend, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v3.Backend, error)
	List(ctx context.Context, opts v1.ListOptions) (*v3.BackendList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v3.Backend, err error)
	BackendExpansion
}
...
func (c *backends) Get(ctx context.Context, name string, options v1.GetOptions) (result *v3.Backend, err error) {
	result = &v3.Backend{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("backends").
...
func (c *backends) List(ctx context.Context, opts v1.ListOptions) (result *v3.BackendList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v3.BackendList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("backends").
...
func (c *backends) Create(ctx context.Context, backend *v3.Backend, opts v1.CreateOptions) (result *v3.Backend, err error) {
	result = &v3.Backend{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("backends").
...
func (c *backends) Update(ctx context.Context, backend *v3.Backend, opts v1.UpdateOptions) (result *v3.Backend, err error) {
	result = &v3.Backend{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backends").
...
func (c *backends) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v3.Backend, err error) {
	result = &v3.Backend{}
