...
type DefaultsLister interface {
	...
	List(selector labels.Selector) (ret []*ingressv3.Defaults, err error)
...
type defaultsLister struct {
	listers.ResourceIndexer[*ingressv3.Defaults]
}

// NewDefaultsLister returns a new DefaultsLister.
func NewDefaultsLister(indexer cache.Indexer) DefaultsLister {
	return &defaultsLister{listers.New[*ingressv3.Defaults](indexer, ingressv3.Resource("defaults"))}
}

// Defaults returns an object that can list and get Defaults.
func (s *defaultsLister) Defaults(namespace string) DefaultsNamespaceLister {
	return defaultsNamespaceLister{listers.NewNamespaced[*ingressv3.Defaults](s.ResourceIndexer, namespace)}
}
...
type DefaultsNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*ingressv3.Defaults, error)
