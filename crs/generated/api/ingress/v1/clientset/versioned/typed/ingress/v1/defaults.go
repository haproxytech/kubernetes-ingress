...
func (c *defaults) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.Defaults, err error) {
	result = &v1.Defaults{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("defaults").
...
func (c *defaults) List(ctx context.Context, opts metav1.ListOptions) (result *v1.DefaultsList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.DefaultsList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("defaults").
...
func (c *defaults) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *defaults) Create(ctx context.Context, defaults *v1.Defaults, opts metav1.CreateOptions) (result *v1.Defaults, err error) {
	result = &v1.Defaults{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("defaults").
...
func (c *defaults) Update(ctx context.Context, defaults *v1.Defaults, opts metav1.UpdateOptions) (result *v1.Defaults, err error) {
	result = &v1.Defaults{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("defaults").
...
func (c *defaults) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *defaults) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *defaults) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.Defaults, err error) {
	result = &v1.Defaults{}
