...
type TCPIndexInformer cache.TypedSharedIndexInformer[*apiingressv1.TCP]

// TCPHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for TCP.
type TCPHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apiingressv1.TCP]

// TCPDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for TCP.
type TCPDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apiingressv1.TCP]

// TCPFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for TCP.
type TCPFilteringHandler = cache.TypedFilteringResourceEventHandler[*apiingressv1.TCP]

// TCPIndexers is a specialization of [cache.TypedIndexers] for TCP.
type TCPIndexers = cache.TypedIndexers[*apiingressv1.TCP]

// DeletedTCP is a specialization of [cache.DeletedObject] for TCP.
type DeletedTCP = cache.DeletedObject[*apiingressv1.TCP]
...
func NewTypedTCPInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) TCPIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiingressv1.TCP](cache.NewSharedIndexInformerWithOptions(
...
func (f *tCPInformer) TypedInformer() TCPIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiingressv1.TCP](f.factory.InformerFor(&apiingressv1.TCP{}, f.defaultInformer))
}
...
func (a *tCPTypedInformerAdapter) TypedInformer() TCPIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiingressv1.TCP](a.Informer())
}
...
func ToTCPIndexInformer(informer cache.SharedIndexInformer) TCPIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiingressv1.TCP](informer)
}
