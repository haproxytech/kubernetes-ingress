...
import (
	...
	ingress "github.com/haproxytech/kubernetes-ingress/crs/generated/api/ingress/v1/informers/externalversions/ingress"
...
func (f *sharedInformerFactory) Ingress() ingress.Interface {
	return ingress.New(f, f.namespace, f.tweakListOptions)
}
