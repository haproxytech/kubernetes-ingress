...
var defaultsResource = v1alpha2.SchemeGroupVersion.WithResource("defaults")

var defaultsKind = v1alpha2.SchemeGroupVersion.WithKind("Defaults")
...
func (c *FakeDefaults) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(defaultsResource, c.ns, name, opts), &v1alpha2.Defaults{})
