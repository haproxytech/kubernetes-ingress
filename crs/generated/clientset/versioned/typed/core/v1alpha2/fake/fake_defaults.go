...
var defaultsResource = schema.GroupVersionResource{Group: "core.haproxy.org", Version: "v1alpha2", Resource: "defaults"}

var defaultsKind = schema.GroupVersionKind{Group: "core.haproxy.org", Version: "v1alpha2", Kind: "Defaults"}
...
func (c *FakeDefaults) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.Defaults, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(defaultsResource, c.ns, name), &v1alpha2.Defaults{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.Defaults), err
}
...
func (c *FakeDefaults) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.DefaultsList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(defaultsResource, defaultsKind, c.ns, opts), &v1alpha2.DefaultsList{})
	...
	list := &v1alpha2.DefaultsList{ListMeta: obj.(*v1alpha2.DefaultsList).ListMeta}
	for _, item := range obj.(*v1alpha2.DefaultsList).Items {
...
func (c *FakeDefaults) Create(ctx context.Context, defaults *v1alpha2.Defaults, opts v1.CreateOptions) (result *v1alpha2.Defaults, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(defaultsResource, c.ns, defaults), &v1alpha2.Defaults{})
...
func (c *FakeDefaults) Update(ctx context.Context, defaults *v1alpha2.Defaults, opts v1.UpdateOptions) (result *v1alpha2.Defaults, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(defaultsResource, c.ns, defaults), &v1alpha2.Defaults{})
...
func (c *FakeDefaults) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(defaultsResource, c.ns, name), &v1alpha2.Defaults{})
...
func (c *FakeDefaults) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha2.DefaultsList{})
	return err
}
...
func (c *FakeDefaults) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.Defaults, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(defaultsResource, c.ns, name, pt, data, subresources...), &v1alpha2.Defaults{})
