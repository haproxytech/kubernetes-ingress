...
func (c *globals) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.Global, err error) {
	result = &v1.Global{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("globals").
...
func (c *globals) List(ctx context.Context, opts metav1.ListOptions) (result *v1.GlobalList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.GlobalList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("globals").
...
func (c *globals) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *globals) Create(ctx context.Context, global *v1.Global, opts metav1.CreateOptions) (result *v1.Global, err error) {
	result = &v1.Global{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("globals").
...
func (c *globals) Update(ctx context.Context, global *v1.Global, opts metav1.UpdateOptions) (result *v1.Global, err error) {
	result = &v1.Global{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("globals").
...
func (c *globals) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *globals) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *globals) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.Global, err error) {
	result = &v1.Global{}
