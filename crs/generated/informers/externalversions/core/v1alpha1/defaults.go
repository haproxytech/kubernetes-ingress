	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha1().Defaults(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha1().Defaults(namespace).Watch(context.TODO(), options)
			},
		},
		&corev1alpha1.Defaults{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *defaultsInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1alpha1.Defaults{}, f.defaultInformer)
}

func (f *defaultsInformer) Lister() v1alpha1.DefaultsLister {
	return v1alpha1.NewDefaultsLister(f.Informer().GetIndexer())
}
