	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha2().Globals(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha2().Globals(namespace).Watch(context.TODO(), options)
			},
		},
		&corev1alpha2.Global{},
		resyncPeriod,
...
func (f *globalInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1alpha2.Global{}, f.defaultInformer)
}

func (f *globalInformer) Lister() v1alpha2.GlobalLister {
	return v1alpha2.NewGlobalLister(f.Informer().GetIndexer())
}
