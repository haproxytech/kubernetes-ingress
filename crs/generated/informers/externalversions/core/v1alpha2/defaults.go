...
import (
	...
	v1alpha2 "github.com/haproxytech/kubernetes-ingress/crs/generated/listers/core/v1alpha2"
...
type DefaultsInformer interface {
	...
	Lister() v1alpha2.DefaultsLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha2().Defaults(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha2().Defaults(namespace).Watch(context.TODO(), options)
			},
		},
		&corev1alpha2.Defaults{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *defaultsInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1alpha2.Defaults{}, f.defaultInformer)
}

func (f *defaultsInformer) Lister() v1alpha2.DefaultsLister {
	return v1alpha2.NewDefaultsLister(f.Informer().GetIndexer())
}
