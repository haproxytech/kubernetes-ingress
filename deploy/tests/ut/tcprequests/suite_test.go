...
type TCPRequestsSuite struct {
	suite.Suite
	test Test
}

func TestTCPRequests(t *testing.T) {
	suite.Run(t, new(TCPRequestsSuite))
}
...
func (suite *TCPRequestsSuite) BeforeTest(suiteName, testName string) {
...
func (suite *TCPRequestsSuite) TearDownSuite() {
	_ = os.Unsetenv("POD_NAME")
}

func (suite *TCPRequestsSuite) UseTCPRequestsFixture() (eventChan chan k8ssync.SyncDataEvent) {
