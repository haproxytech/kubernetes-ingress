...
type HTTPChecksSuite struct {
	suite.Suite
	test Test
}

func TestHTTPChecks(t *testing.T) {
	suite.Run(t, new(HTTPChecksSuite))
}
...
func (suite *HTTPChecksSuite) BeforeTest(suiteName, testName string) {
...
func (suite *HTTPChecksSuite) TearDownSuite() {
	_ = os.Unsetenv("POD_NAME")
}

func (suite *HTTPChecksSuite) UseHTTPChecksFixture() (eventChan chan k8ssync.SyncDataEvent) {
