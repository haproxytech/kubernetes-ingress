...
type TCPResponsesSuite struct {
	suite.Suite
	test Test
}

func TestTCPResponses(t *testing.T) {
	suite.Run(t, new(TCPResponsesSuite))
}
...
func (suite *TCPResponsesSuite) BeforeTest(suiteName, testName string) {
...
func (suite *TCPResponsesSuite) TearDownSuite() {
	_ = os.Unsetenv("POD_NAME")
}

func (suite *TCPResponsesSuite) UseTCPResponsesFixture() (eventChan chan k8ssync.SyncDataEvent) {
