...
type TCPChecksSuite struct {
	suite.Suite
	test Test
}

func TestTCPChecks(t *testing.T) {
	suite.Run(t, new(TCPChecksSuite))
}
...
func (suite *TCPChecksSuite) BeforeTest(suiteName, testName string) {
...
func (suite *TCPChecksSuite) TearDownSuite() {
	_ = os.Unsetenv("POD_NAME")
}

func (suite *TCPChecksSuite) UseTCPChecksFixture() (eventChan chan k8ssync.SyncDataEvent) {
