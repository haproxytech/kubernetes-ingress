...
type LogTargetsSuite struct {
	suite.Suite
	test Test
}

func TestLogTargets(t *testing.T) {
	suite.Run(t, new(LogTargetsSuite))
}
...
func (suite *LogTargetsSuite) BeforeTest(suiteName, testName string) {
...
func (suite *LogTargetsSuite) TearDownSuite() {
	_ = os.Unsetenv("POD_NAME")
}

func (suite *LogTargetsSuite) UseLogTargetsFixture() (eventChan chan k8ssync.SyncDataEvent) {
