...
type ServerSwitchingSuite struct {
	suite.Suite
	test Test
}

func TestServerSwitching(t *testing.T) {
	suite.Run(t, new(ServerSwitchingSuite))
}
...
func (suite *ServerSwitchingSuite) BeforeTest(suiteName, testName string) {
...
func (suite *ServerSwitchingSuite) TearDownSuite() {
	_ = os.Unsetenv("POD_NAME")
}

func (suite *ServerSwitchingSuite) UseServerSwitchingFixture() (eventChan chan k8ssync.SyncDataEvent) {
