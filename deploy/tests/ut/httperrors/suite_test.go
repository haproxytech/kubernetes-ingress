...
type HTTPErrorsSuite struct {
	suite.Suite
	test Test
}

func TestHTTPErrors(t *testing.T) {
	suite.Run(t, new(HTTPErrorsSuite))
}
...
func (suite *HTTPErrorsSuite) BeforeTest(suiteName, testName string) {
...
func (suite *HTTPErrorsSuite) TearDownSuite() {
	_ = os.Unsetenv("POD_NAME")
}

func (suite *HTTPErrorsSuite) UseHTTPErrorsFixture() (eventChan chan k8ssync.SyncDataEvent) {
