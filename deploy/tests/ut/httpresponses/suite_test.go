...
type HTTPResponsesSuite struct {
	suite.Suite
	test Test
}

func TestHTTPResponses(t *testing.T) {
	suite.Run(t, new(HTTPResponsesSuite))
}
...
func (suite *HTTPResponsesSuite) BeforeTest(suiteName, testName string) {
...
func (suite *HTTPResponsesSuite) TearDownSuite() {
	_ = os.Unsetenv("POD_NAME")
}

func (suite *HTTPResponsesSuite) UseHTTPResponsesFixture() (eventChan chan k8ssync.SyncDataEvent) {
