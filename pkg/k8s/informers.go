		...
		cache.InformerOptions{
			...
			Handler: cache.ResourceEventHandlerFuncs{
				AddFunc: func(obj interface{}) {
					...
					eventChan <- k8ssync.SyncDataEvent{
						SyncType:  k8ssync.POD,
						Namespace: meta.Namespace,
						Name:      meta.Name,
						Data:      store.PodEvent{Status: store.ADDED, Name: meta.Name},
					}
				},
				DeleteFunc: func(obj interface{}) {
					...
					eventChan <- k8ssync.SyncDataEvent{
						...
						Namespace: meta.Namespace,
						Name:      meta.Name,
						Data:      store.PodEvent{Status: store.DELETED, Name: meta.Name},
					}
				},
				UpdateFunc: func(oldObj, newObj interface{}) {
					...
					eventChan <- k8ssync.SyncDataEvent{
						...
						Namespace: meta.Namespace,
						Name:      meta.Name,
						Data:      store.PodEvent{Status: store.MODIFIED, Name: meta.Name},
					}
				},
			},
		})
