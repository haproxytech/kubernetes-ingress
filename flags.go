...
type OSArgs struct {
	...
	DefaultBackendService NamespaceValue `long:"default-backend-service" description:"default service to serve 404 page. If not specified HAProxy serves http 400" default:""`
